...
import { GetInvestmentStatisticsUseCase } from "@dash/core/usecases/GetInvestmentStatisticsUseCase";
...
export const InvestmentsCard = () => {
    ...
    useEffect(() => {
        ...
        statisticsUseCase
            ...
            .catch(() => {
                if (!cancelled) setError("Não foi possível carregar os investimentos.");
            })
            .finally(() => {
    ...
    return (
        <div className="w-full shrink-0 mt-3">
            <section className="flex w-full flex-col gap-2 overflow-hidden rounded-xl bg-zinc-300 px-6 text-zinc-900 p-6">
                <div className="mb-4">
                    <h2 className="relative z-10 text-lg font-semibold text-zinc-900">Investimentos</h2>
                </div>
